...
from fsl.config import config_SL, config_meta
from fsl.Framework import IOManager, Visualizer, DataManager, ModelManager, DataManager1
...
class Learner():
    def __init__(self, config):
        ...
        self.dataManager1 = DataManager1.DataManager(self)
    ...
    def reset_dataManager1(self):
        self.dataManager1 = DataManager1.DataManager(self)
        self.dataManager1.load_data()
        self.IOManager.log.Info('Reset DataManager1 Over.')
